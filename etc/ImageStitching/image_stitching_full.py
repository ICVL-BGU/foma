...
def find_chessboards(gray_im, pattern_size=(6, 9)):
    ...
    while True:
        ...
        if pattern_found:
            ...
            cv2.fillConvexPoly(mask, np.int32([refined_corners]), (255, 255, 255).tolist())
...
def calibrate_cameras(base_dir, calib_range, fx, fy, cx, cy):
...
def match_images(base_dir, match_range, calib_params):
...
if __name__ == "__main__":
    ...
    if args.calibrate:
        ...
        calib_params = calibrate_cameras(args.dir, args.calib_range, args.fx, args.fy, args.cx, args.cy)
    ...
    if args.match:
        ...
        matched_points = match_images(args.dir, args.match_range, calib_params)
    ...
    if args.stitch:
        ...
        stitch_images(args.dir, calib_params, homographies, args.base_image)
