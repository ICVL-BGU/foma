...
camera_dirs = ["G:/My Drive/Alex/School/MSc/Thesis/FOV/CodeBackUp/etc/Camera_1",
               "G:/My Drive/Alex/School/MSc/Thesis/FOV/CodeBackUp/etc/Camera_2",
               "G:/My Drive/Alex/School/MSc/Thesis/FOV/CodeBackUp/etc/Camera_3",
               "G:/My Drive/Alex/School/MSc/Thesis/FOV/CodeBackUp/etc/Camera_4",
               "G:/My Drive/Alex/School/MSc/Thesis/FOV/CodeBackUp/etc/Camera_5"]
...
for camera_dir in camera_dirs:
    ...
    calib_params = {
        'K': K,
        'D': D,
        'new_camera_mtx': cv2.getOptimalNewCameraMatrix(K, D, (gray_im.shape[1], gray_im.shape[0]), 1, (gray_im.shape[1], gray_im.shape[0]))
    }
